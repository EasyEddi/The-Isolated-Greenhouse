...
FURNITURE = [
    {
        ...
        "label": "Living_Fridge",
        "location": (-1438.702, -50.541, 4.077),
    ...
    },
    {
        ...
        "location": (-1449.335, 53.171, 129.139),
        "rotation": (0.0, -90.0, 0.0),
